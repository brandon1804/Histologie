...
$id = $_GET['id'] ?? 0;
$query = "SELECT * FROM frequent_ask_questions WHERE faq_id = $id";
                    ...
                    <div id="addFAQContent" class="mt-4 mb-4">
                        <div class="col-12">
                            <div class="card shadow" style="border-color: #fff; border-radius: 10px;">
                                <div class="card-body">
                                    <h1 class="card-title mb-4">Edit FAQ</h1>
                                    <form id="editFAQPage" enctype="multipart/form-data"> 
                                        <input type="hidden" name="FAQid" value="<?php echo $id?>">
                                        <div class="form-group mt-3">
                                            <label for="question">Question</label>
                                            <input class="form-control" name="FAQquestion" rows="1" placeholder="Enter the question" value="<?php echo $question?>"/>
                                        </div>
                                        <div class="form-group">
                                            <label for="answer">Answer</label>
                                            <textarea type="text" class="form-control" name="FAQAnswer" rows="2" placeholder="Enter the question's answer(s)"><?php echo $answer?></textarea>
                                        </div>
